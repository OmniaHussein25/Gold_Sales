...
namespace Gold_Sales.Models
{
    ...
    public partial class SalesRepComm
    {
        public string SalesRepID { get; set; }
        public System.DateTime SalesFromDate { get; set; }
        public Nullable<System.DateTime> SalesToDate { get; set; }
        public int SalesCommLinenum { get; set; }
        public Nullable<decimal> SalesFromValue { get; set; }
        public Nullable<decimal> SalesToValue { get; set; }
        public Nullable<decimal> SalesCommPrc { get; set; }
