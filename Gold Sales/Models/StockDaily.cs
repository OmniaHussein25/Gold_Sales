...
namespace Gold_Sales.Models
{
    ...
    {
        public string inventlocatioinid { get; set; }
        public System.DateTime stockdate { get; set; }
        public Nullable<decimal> itemweight21 { get; set; }
        public Nullable<decimal> itemweight18 { get; set; }
        public Nullable<int> itemcount21 { get; set; }
        public Nullable<int> itemcount18 { get; set; }
        public Nullable<byte> salesclosed { get; set; }
        public Nullable<byte> salesopen { get; set; }
        public Nullable<byte> transclosed { get; set; }
        public Nullable<byte> transopen { get; set; }
        public Nullable<byte> returnclosed { get; set; }
        public Nullable<byte> returnopen { get; set; }
        public Nullable<decimal> itemweight21P { get; set; }
        public Nullable<decimal> itemweight18P { get; set; }
        public Nullable<decimal> itemcount21P { get; set; }
        public Nullable<decimal> itemcount18P { get; set; }
